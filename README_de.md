...
2. **Klonen/Herunterladen**: Laden Sie den Quellcode auf Ihren lokalen Rechner herunter.
...
Klicken Sie nach der Konfiguration auf **"Basis-FIR generieren"** (Phase 1), gefolgt von der grünen Generierungsschaltfläche in Phase 2. Die App erstellt `.wav`-Impulsantwortdateien für jeden verarbeiteten Lautsprecher und eine globale EQ-Datei für Ihren Convolver. Wenden Sie in Ihrem System eine globale negative Verstärkung an, um Clipping zu vermeiden.
